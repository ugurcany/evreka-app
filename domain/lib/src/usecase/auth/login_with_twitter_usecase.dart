...
class LoginWithTwitterUsecase extends Usecase {
  ...
  Stream<RequestResult> invoke([dynamic params]) async* {
    ...
    await _authRepository.authenticateWithTwitterPart1();
    ...
    await _authRepository.authenticateWithTwitterPart2(link);
